function Quote(){
    ...
    var randomm=Math.floor(Math.random ()*arr_name.length );
    document.getElementById("author-name").innerHTML=arr_name[randomm];
    document.getElementById("quotee").innerHTML=arr_quote [randomm];
}
Quote();
